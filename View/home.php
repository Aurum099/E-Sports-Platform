...
<body>
    ...
    <div class="topbar">
       <span class="material-symbols-outlined sports">sports_esports</span>
        ...
        <h2><a href="../View/login.php" onclick="return confirm('You need to log in to see Community Hub. Do you want to log in?')">Community Hub</a></h2>
        </div>
        <div class="topbar_option">
        <h2><a href="../View/login.php">Login</a></h2>
        </div> 
